...
- [ ] **2024 Atlas Data Ingestion & Ruleset-Aware Character Creation — Phase 2**
  - **Status:**
    - 2024 Species Foundation: implemented / verified
    - 2024 Class Foundation: implemented / verified (Fighter, Wizard, Cleric, Rogue foundation implemented; remaining classes pending)
  ...
  - **Implementation order:** 2024 Species Foundation (implemented / verified) → 2024 Class Foundation (implemented / verified: Fighter, Wizard, Cleric, Rogue; remaining classes pending) → 2024 Class Levels / Features (current phase) → Backgrounds/Origins → 2024 Subclasses → Feats integration → Spells → remaining rules-sensitive domains → complete ruleset integration tests.
