...
- **Species**: `/assets/atlas/species/json/14/` vs `/24/` (Foundation implemented / verified: Human, Dwarf, Elf, Halfling, Orc).
- **Classes**: `/assets/atlas/class/json/14/` vs `/24/` (Foundation implemented / verified: Fighter, Wizard, Cleric, Rogue representative scope; remaining classes pending).
- **Class Levels / Features**: `/assets/atlas/class/levels/14/` vs `/24/` (Current phase: Level 1 foundation for Fighter, Wizard, Cleric, Rogue).
