...
2024 Base Class Foundation: 12/12 ✅
→ implemented / verified (12/12 core classes in /class/json/24/)

2024 Base Class Progression: 12/12 ✅
→ implemented / verified (levels 1-20 level arrays & files for all 12 core classes in /class/levels/24/)

2024 Base Class Features: 12/12 ✅
→ implemented / verified (canonical 2024 base class feature definitions for all 12 core classes in /features/json/)

2024 Subclass Features: pending ⏳
→ subclass feature data ingestion pending
...
- [x] Ingest 2024 Class Levels & Features Level 1-20 base progression for all 12 classes under `/class/levels/24/` and `/features/json/`.
