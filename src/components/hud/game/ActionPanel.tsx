      ...
      <div className="w-full flex flex-col bg-stone-950 border-t-2 border-dragon-gold overflow-hidden shadow-2xl font-serif">
        ...
        <div className="flex-1 p-6 flex flex-col md:flex-row items-center justify-around gap-6">
          <div className="flex flex-col items-center md:items-start gap-2">
            ...
            <p className="text-[11px] text-white/50 max-w-md text-center md:text-left leading-relaxed">
          ...
          <div className="flex flex-col gap-3 bg-black/30 border border-white/5 p-4 rounded-xl">
            <div className="flex items-center gap-4">
              <span className="text-[10px] font-black text-emerald-400 uppercase tracking-widest w-20 text-right">Successes</span>
            ...
            <div className="flex items-center gap-4">
              <span className="text-[10px] font-black text-red-400 uppercase tracking-widest w-20 text-right">Failures</span>
              <div className="flex gap-2">
                {[1, 2, 3].map(i => (
                  <div
                    key={`failure-dot-${i}`}
          ...
          <div className="flex items-center gap-4">
            {!isStable && !isDead ? (
              <motion.button
                ...
                className="px-6 py-3 bg-dragon-red text-white rounded-sm font-header font-black uppercase tracking-[0.2em] text-xs shadow-xl hover:brightness-110 transition-all border-2 border-white/20"
              >
                Roll Death Save
              </motion.button>
            ) : isStable ? (
            ...
            <motion.button
              ...
              className="px-5 py-3 bg-stone-800 hover:bg-stone-700 text-white rounded-sm font-header font-black uppercase tracking-[0.2em] text-xs transition-all border border-white/10"
            >
              End Turn
            </motion.button>
          </div>
