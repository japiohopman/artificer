    ...
    <div className="fixed inset-0 pointer-events-none z-[9999]">
      ...
      {isFastForwarding && (
        <div className="absolute top-20 left-1/2 -translate-x-1/2 z-[10000] flex flex-col items-center gap-2">
          <div className="flex items-center gap-2 px-4 py-2 bg-dragon-red/80 border-2 border-dragon-gold rounded-full shadow-2xl animate-pulse">
          ...
          <div className="text-[8px] font-bold text-dragon-gold uppercase tracking-widest bg-black/40 px-2 py-0.5 rounded">
