...
import { ActionView } from '../hud/game/ActionView';
...
const ArcaneCodex: React.FC = () => {
  ...
  const {
    monstersList, monsterCategories, materialsList, equipmentList, keyItemsList, booksList, 
                                      ...
                                      {Object.keys(m.versions).sort().map((tierStr) => {
                                        ...
                                        return (
                                          <button
                                            ...
                                            onClick={(e) => {
                                              e.stopPropagation();
                                              selectItem(version.index, explorerTab);
                                              playClickSound();
                                            }}
