...
export const SPELL_SPRITE_MANIFEST: Record<string, SpellSpriteCellMapping> = {
  ...
  'spell.ray_of_frost': { visualId: 'spell.ray_of_frost', level: 0, status: 'READY', sheetId: 'cantrips_sheet_01', row: 3, col: 2, school: 'evocation' },
  'spell.shocking_grasp': { visualId: 'spell.shocking_grasp', level: 0, status: 'READY', sheetId: 'cantrips_sheet_01', row: 3, col: 3, school: 'evocation' },

  // --- LEVEL 1 SPELLS SHEET 01 ---
  'spell.magic_missile': { visualId: 'spell.magic_missile', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_01', row: 0, col: 0, school: 'evocation' },
  'spell.burning_hands': { visualId: 'spell.burning_hands', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_01', row: 0, col: 1, school: 'evocation' },
  'spell.thunderwave': { visualId: 'spell.thunderwave', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_01', row: 0, col: 2, school: 'evocation' },
  'spell.chromatic_orb': { visualId: 'spell.chromatic_orb', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_01', row: 0, col: 3, school: 'evocation' },
  'spell.cure_wounds': { visualId: 'spell.cure_wounds', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_01', row: 1, col: 0, school: 'evocation' },
  'spell.healing_word': { visualId: 'spell.healing_word', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_01', row: 1, col: 1, school: 'evocation' },
  'spell.bless': { visualId: 'spell.bless', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_01', row: 1, col: 2, school: 'enchantment' },
  'spell.bane': { visualId: 'spell.bane', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_01', row: 1, col: 3, school: 'enchantment' },
  'spell.shield': { visualId: 'spell.shield', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_01', row: 2, col: 0, school: 'abjuration' },
  'spell.absorb_elements': { visualId: 'spell.absorb_elements', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_01', row: 2, col: 1, school: 'abjuration' },
  'spell.fog_cloud': { visualId: 'spell.fog_cloud', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_01', row: 2, col: 2, school: 'conjuration' },
  'spell.grease': { visualId: 'spell.grease', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_01', row: 2, col: 3, school: 'conjuration' },
  'spell.guiding_bolt': { visualId: 'spell.guiding_bolt', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_01', row: 3, col: 0, school: 'evocation' },
  'spell.inflict_wounds': { visualId: 'spell.inflict_wounds', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_01', row: 3, col: 1, school: 'necromancy' },
  'spell.witch_bolt': { visualId: 'spell.witch_bolt', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_01', row: 3, col: 2, school: 'evocation' },
  'spell.hellish_rebuke': { visualId: 'spell.hellish_rebuke', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_01', row: 3, col: 3, school: 'evocation' },

  // --- LEVEL 1 SPELLS SHEET 02 ---
  'spell.alarm': { visualId: 'spell.alarm', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_02', row: 0, col: 0, school: 'abjuration' },
  'spell.animal_friendship': { visualId: 'spell.animal_friendship', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_02', row: 0, col: 1, school: 'enchantment' },
  'spell.armor_of_agathys': { visualId: 'spell.armor_of_agathys', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_02', row: 0, col: 2, school: 'abjuration' },
  'spell.command': { visualId: 'spell.command', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_02', row: 0, col: 3, school: 'enchantment' },
  'spell.comprehend_languages': { visualId: 'spell.comprehend_languages', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_02', row: 1, col: 0, school: 'divination' },
  'spell.detect_magic': { visualId: 'spell.detect_magic', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_02', row: 1, col: 1, school: 'divination' },
  'spell.detect_poison_and_disease': { visualId: 'spell.detect_poison_and_disease', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_02', row: 1, col: 2, school: 'divination' },
  'spell.disguise_self': { visualId: 'spell.disguise_self', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_02', row: 1, col: 3, school: 'illusion' },
  'spell.dissonant_whispers': { visualId: 'spell.dissonant_whispers', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_02', row: 2, col: 0, school: 'enchantment' },
  'spell.entangle': { visualId: 'spell.entangle', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_02', row: 2, col: 1, school: 'conjuration' },
  'spell.feather_fall': { visualId: 'spell.feather_fall', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_02', row: 2, col: 2, school: 'transmutation' },
  'spell.heroism': { visualId: 'spell.heroism', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_02', row: 2, col: 3, school: 'enchantment' },
  'spell.hunters_mark': { visualId: 'spell.hunters_mark', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_02', row: 3, col: 0, school: 'divination' },
  'spell.identify': { visualId: 'spell.identify', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_02', row: 3, col: 1, school: 'divination' },
  'spell.silent_image': { visualId: 'spell.silent_image', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_02', row: 3, col: 2, school: 'illusion' },
  'spell.sleep': { visualId: 'spell.sleep', level: 1, status: 'READY', sheetId: 'spells_level1_sheet_02', row: 3, col: 3, school: 'enchantment' },
